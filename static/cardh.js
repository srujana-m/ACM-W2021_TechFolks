function moveF() {
  ...
  document.querySelector("#card1").style.left = "30vw";
  document.querySelector("#card2").style.left = "50vw";
  document.querySelector("#card3").style.left = "70vw";
